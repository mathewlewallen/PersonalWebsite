...
const INVALID_CONFIG_ERROR: CustomError = {
  ...
  subTitle: (
    <p>
      Please provide correct config in <code>personalwebsite.config.ts</code>.
    </p>
  ),
};

const setTooManyRequestError = (resetTime: string): CustomError => {
  return {
    status: 429,
...
const INVALID_GITHUB_USERNAME_ERROR: CustomError = {
  ...
  subTitle: (
    <p>
      ...
      <code>personalwebsite.config.ts</code>.
    </p>
  ),
};
...
const LOCAL_STORAGE_KEY_NAME = 'personalwebsite-theme';

const BG_COLOR = 'bg-base-300';
